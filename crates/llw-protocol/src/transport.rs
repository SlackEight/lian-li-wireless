...
impl UsbTransport {
    pub fn open(vid: u16, pid: u16) -> Result<Self, ProtocolError> {
        let device = rusb::devices()?
            ...
            .ok_or(ProtocolError::DeviceNotFound { vid, pid })?;
    ...
    pub fn detach_and_configure(&mut self, name: &str) -> Result<(), ProtocolError> {
    ...
    pub fn write(&self, data: &[u8], timeout: Duration) -> Result<usize, ProtocolError> {
    ...
    pub fn read(&self, buf: &mut [u8], timeout: Duration) -> Result<usize, ProtocolError> {
